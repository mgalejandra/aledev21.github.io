...
<html lang="es">
    ...
    <head>
        ...
        <meta name="referrer" content="no-referrer-when-downgrade" />
         ...
         <!-- FavIcon -->
        <link rel="shortcut icon" type="image/jpg" href="assets/img/ar_logo.jpg" />
    ...
    <body>
            ...
            <nav id="nav" class="navbar nav-transparent">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <div class="navbar-brand">
                            <a href="https://alrivasp.github.io/">
                                <img class="logo" src="assets/img/LogoIcialAlvaroRivasInvert.png" alt="Alvaro Rivas">
                                <img class="logo-alt" src="assets/img/LogoIcialAlvaroRivas.png" alt="logo Alvaro Rivas">
                            </a>
                        </div>
                        <!-- /Logo -->
                        <!-- Collapse nav button -->
                    ...
                    <ul class="main-nav nav navbar-nav navbar-right">
                        ...
                        <li><a href="assets/cv/CV_Alvaro_Rivas_Portafolio.pdf" target="_blank">Curriculum</a></li>
                    </ul>
                    <!-- /Main navigation -->
                </div>
            </nav>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <img src="assets/images/AlvaroRivas.jpg" alt="Alvaro Rivas" class="image-ppal">
                            <div class="home-content">
                                <h1 class="white-text">Ingeniero en Informatica<h2 class="white-text">Desarrollador Full Stack<br>Consultor TI</h2></h1>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-6 work">
                        <img class="img-responsive" src="assets/images/works/EntelEasy.png" alt="App Productividad">
                        <div class="overlay"></div>
                        <div class="work-content">
                            ...
                            <div class="work-link">
                                ...
                                <a class="lightbox" href="assets/images/works/EntelEasyPreview.png"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- /Work -->
                    <!-- Work -->
                    <div class="col-md-4 col-xs-6 work">
                        <img class="img-responsive" src="assets/images/works/JeansLover.png" alt="Jeans Lover Shop">
                        <div class="overlay"></div>
                        <div class="work-content">
                            ...
                            <div class="work-link">
                                ...
                                <a class="lightbox" href="assets/images/works/JeansLoverPreview.png"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- /Work -->
                    <!-- Work -->
                    <div class="col-md-4 col-xs-6 work">
                        <img class="img-responsive" src="assets/images/works/WHISPER.png" alt="Whisper">
                        <div class="overlay"></div>
                        <div class="work-content">
                            ...
                            <div class="work-link">
                                ...
                                <a class="lightbox" href="assets/images/works/WhisperPreview.png"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- /Work -->
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <img src="assets/images/studies/DuocUC.png" alt="Ingeniero en Informatica" class="img-responsive">
                                    <div class="carousel-caption">
                                    <span class="text-primary">Estudios de Actualización 2019</span>
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="assets/images/studies/MineducTecnico.png" alt="Tecnico en Telecomunicaciones" class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Estudios de Actualización 2004</span>
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="assets/images/studies/DesafioLatamFullStack.png" alt="Full Stack " class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Estudios de Actualización 2020</span>
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="assets/images/studies/DesafioLatamFundamentosWeb.png" alt="Fundamentos Web " class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Estudios de Actualización 2020</span>
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="assets/images/studies/DesafioLatamProgramacion.png" alt="Programación Basica" class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Estudios de Actualización 2020</span>
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="assets/images/studies/DesafioLatamBd.png" alt="Base de Datos" class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Estudios de Actualización 2020</span>
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="assets/images/studies/DesafioLatamAppWeb.png" alt="Programación Web" class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Estudios de Actualización 2020</span>
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="assets/images/studies/DesafioLatamAppWebJS.png" alt="Programación Web con JavaScript" class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Estudios de Actualización 2020</span>
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="assets/images/studies/DesafioLatamGit.png" alt="GIT" class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Estudios de Actualización 2020</span>
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="assets/images/studies/SenceAppEnLaNube.png" alt="Curso Profesional de Git y GitHub" class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Estudios de Actualización 2020</span>
                                    </div>
                                </div>
                                <div class="item ">
                                    <img src="assets/images/studies/SenceVisualizadorBigData.png" alt="Fundamentos de Ingenieria de software " class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Estudios de Actualización 2020</span>
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="assets/images/studies/GoogleCompetencias.png" alt="HTML Fundamentals course" class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Estudios de Actualización 2020</span>
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="assets/images/studies/GoogleCloud.png" alt="SQL Fundamentals course" class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Estudios de Actualización 2020</span>
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-lg-12 col-md-12">
                        ...
                        <div id="carousel-example-generic-certi" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                    <img src="assets/images/certified/SFPC.jpg" alt="Certificado Scrum" class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Certificados 2020</span>
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="assets/images/certified/RWVC.jpg" alt="Certificado Trabajo Remoto" class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Certificados 2020</span>
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="assets/images/certified/CSFPC.jpg" alt="Certificado Ciber Security " class="img-responsive">
                                    <div class="carousel-caption">
                                        <span class="text-primary">Certificados 2020</span>
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="assets/images/certified/Toeic.png" alt="Toeic Bridge" class="img-responsive">
                                    <div class="carousel-caption">
                            ...
                            <!-- Controls -->
                            <a class="left carousel-control" href="#carousel-example-generic-certi" role="button" data-slide="prev">
                                <span class="fa fa-chevron-left" aria-hidden="true"></span>
                                <span class="sr-only">Previous</span>
                            </a>
                            <a class="right carousel-control" href="#carousel-example-generic-certi" role="button" data-slide="next">
                                <span class="fa fa-chevron-right" aria-hidden="true"></span>
                                <span class="sr-only">Next</span>
                            </a>
                        </div>
        ...
        <div id="experience" class="section md-padding">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <!--Foto--->
                    <img src="assets/img/migrante_logo.png" alt="Logo Entel" style="width: 100px; ">
                    <!--Titulo--->
                    ...
                    <hr>
                    <!--Foto--->
                    <img src="assets/img/ar_logo.jpg" alt="Logo Alrivas" style="width: 100px; ">
                    <!--Titulo--->
                    ...
                    <hr>
                    <!--Foto--->
                    <img src="assets/img/entel_logo.png" alt="Logo Entel" style="width: 100px; ">
                    <!--Titulo--->
                    ...
                    <hr>
                    <!--Foto--->
                    <img src="assets/img/abcdin_logo.png" alt="Logo ABCDIN" style="width: 100px; ">
                    <!--Titulo--->
                    ...
                    <hr>
                    <!--Foto--->
                    <img src="assets/img/din_logo.png" alt="Logo Din" style="width: 100px; ">
                    <!--Titulo--->
                            ...
                            <div id="testimonial-slider" class="owl-carousel owl-theme">
                                ...
                                <div class="testimonial">
                                    <div class="testimonial-meta">
                                        <img src="assets/images/FranciscoGallardo.jpg" alt="Francisco Gallardo">
                                ...
                                <div class="testimonial">
                                    <div class="testimonial-meta">
                                        <img src="assets/images/RaulDiaz.jpg" alt="Raul DIaz">
                                ...
                                <div class="testimonial">
                                    <div class="testimonial-meta">
                                        <img src="assets/images/GinoAntognoni.jpg" alt="Gino Antognoni">
                                ...
                                <div class="testimonial">
                                    <div class="testimonial-meta">
                                        <img src="assets/images/CesarRebolledo.jpg" alt="Cesas Rebolledo">
                                ...
                                <div class="testimonial">
                                    <div class="testimonial-meta">
                                        <img src="assets/images/KarlaNunez.jpg" alt="Karla Nunez">
                                ...
                                <div class="testimonial">
                                    <div class="testimonial-meta">
                                        <img src="assets/images/ConstanzaPerez.png" alt="Karla Nunez">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="footer-logo">
                            <a href="https://alrivasp.github.io/"><img src="assets/img/LogoIcialAlvaroRivas.png" alt="logo"></a>
                        </div>
                        <!-- /footer logo -->
                        <!-- footer follow -->
                        <ul class="footer-follow">
                            ...
                            <li><a href="assets/cv/CV_Alvaro_Rivas_Portafolio.pdf" target="_blank"><i class="">CV</i></a></li>
        ...
        <script type="text/javascript" src="assets/function/smtp.js"></script>
        <script type="text/javascript" src="assets/function/SendMail.js"></script>
    </body>
